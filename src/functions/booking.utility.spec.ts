...
describe('BookingUtility', () => {
    ...
    it('startTimeOption input[startDate(weekday)] #range should return [18:00,18:30,...,21:30,22:00]', () => {
        const expectedResult = [
            { time: '18:00', duration: '0 hr' },
            { time: '18:30', duration: '0 hr' },
            { time: '19:00', duration: '0 hr' },
            { time: '19:30', duration: '0 hr' },
            { time: '20:00', duration: '0 hr' },
            { time: '20:30', duration: '0 hr' },
            { time: '21:00', duration: '0 hr' },
            { time: '21:30', duration: '0 hr' },
            { time: '22:00', duration: '0 hr' },
        ]
    ...
    it('startTimeOption input[startDate(weekend)] #range should return [9:00,9:30,...,19:30,20:00]', () => {
        const expectedResult = [
            { time: '9:00', duration: '0 hr' },
            { time: '9:30', duration: '0 hr' },
            { time: '10:00', duration: '0 hr' },
            { time: '10:30', duration: '0 hr' },
            { time: '11:00', duration: '0 hr' },
            { time: '11:30', duration: '0 hr' },
            { time: '12:00', duration: '0 hr' },
            { time: '12:30', duration: '0 hr' },
            { time: '13:00', duration: '0 hr' },
            { time: '13:30', duration: '0 hr' },
            { time: '14:00', duration: '0 hr' },
            { time: '14:30', duration: '0 hr' },
            { time: '15:00', duration: '0 hr' },
            { time: '15:30', duration: '0 hr' },
            { time: '16:00', duration: '0 hr' },
            { time: '16:30', duration: '0 hr' },
            { time: '17:00', duration: '0 hr' },
            { time: '17:30', duration: '0 hr' },
            { time: '18:00', duration: '0 hr' },
            { time: '18:30', duration: '0 hr' },
            { time: '19:00', duration: '0 hr' },
            { time: '19:30', duration: '0 hr' },
